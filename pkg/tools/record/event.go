...
import (
	...
	"github.com/solid-wang/covid/pkg/tools/record/util"
	ref "github.com/solid-wang/covid/pkg/tools/reference"
...
// RequestConstructionError copy from client-go/rest/request.go
