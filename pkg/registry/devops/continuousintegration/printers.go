...
func printContinuousIntegrationList(continuousIntegrationList *devops.ContinuousIntegrationList, options printers.GenerateOptions) ([]metav1.TableRow, error) {
...
func printContinuousIntegration(continuousIntegration *devops.ContinuousIntegration, options printers.GenerateOptions) ([]metav1.TableRow, error) {
	row := metav1.TableRow{
