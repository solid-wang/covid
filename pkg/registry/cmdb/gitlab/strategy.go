...
func SelectableFields(obj *cmdb.Gitlab) fields.Set {
...
func (Strategy) PrepareForUpdate(ctx context.Context, obj, old runtime.Object) {
	newGitlab := obj.(*cmdb.Gitlab)
	oldGitlab := old.(*cmdb.Gitlab)
	newGitlab.Spec.ProjectIDServerMap = oldGitlab.Spec.ProjectIDServerMap
}
