...
func GetAttrs(obj runtime.Object) (labels.Set, fields.Set, error) {
	apiserver, ok := obj.(*batch.ContinuousIntegration)
	if !ok {
...
func SelectableFields(obj *batch.ContinuousIntegration) fields.Set {
...
func (Strategy) PrepareForUpdate(ctx context.Context, obj, old runtime.Object) {
	newCI := obj.(*batch.ContinuousIntegration)
	oldCI := old.(*batch.ContinuousIntegration)
...
func (StatusStrategy) PrepareForUpdate(ctx context.Context, obj, old runtime.Object) {
	newDeployment := obj.(*batch.ContinuousIntegration)
	oldDeployment := old.(*batch.ContinuousIntegration)
