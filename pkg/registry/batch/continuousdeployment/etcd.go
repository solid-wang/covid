...
func NewREST(scheme *runtime.Scheme, optsGetter generic.RESTOptionsGetter) (Storage, error) {
	...
	store := &genericregistry.Store{
		NewFunc:                  func() runtime.Object { return &batch.ContinuousDeployment{} },
		NewListFunc:              func() runtime.Object { return &batch.ContinuousDeploymentList{} },
		PredicateFunc:            Match,
		DefaultQualifiedResource: batch.Resource("continuousdeployments"),
		...
		//TableConvertor: rest.NewDefaultTableConvertor(batch.Resource("continuousdeployments")),
	}
	...
	return Storage{
		ContinuousDeployment: &REST{store},
...
func (r *StatusREST) New() runtime.Object {
	return &batch.ContinuousDeployment{}
}
