...
type ApplicationInterface interface {
	...
	UpdateStatus(ctx context.Context, application *v1.Application, opts metav1.UpdateOptions) (*v1.Application, error)
...
func newApplications(c *AppV1Client, namespace string) *applications {
	return &applications{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *applications) UpdateStatus(ctx context.Context, application *v1.Application, opts metav1.UpdateOptions) (result *v1.Application, err error) {
	result = &v1.Application{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("applications").
